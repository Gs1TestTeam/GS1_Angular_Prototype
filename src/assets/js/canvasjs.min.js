...
(function() {
  ...
  function Ta(m, s, q) {
    "millisecond" === q
      ? m.setMilliseconds(m.getMilliseconds() + 1 * s)
      : "second" === q
        ? m.setSeconds(m.getSeconds() + 1 * s)
        : "minute" === q
          ? m.setMinutes(m.getMinutes() + 1 * s)
          : "hour" === q
            ? m.setHours(m.getHours() + 1 * s)
            : "day" === q
              ? m.setDate(m.getDate() + 1 * s)
              : "week" === q
                ? m.setDate(m.getDate() + 7 * s)
                : "month" === q
                  ? m.setMonth(m.getMonth() + 1 * s)
                  : "year" === q && m.setFullYear(m.getFullYear() + 1 * s);
    return m;
  }
  function ha(m, s) {
    var q = !1;
  ...
  function bb(m) {
    if (W.fSDec)
      m[ga("`eeDwdouMhrudods")](ga("e`u`@ohl`uhnoHuds`uhnoDoe"), function() {
        W._fTWm && W._fTWm(m);
      });
  }
  function Ua(m, s, q) {
  ...
  function cb(m) {
    if (!db) {
      ...
      "undefined" === typeof qa.Chart.creditHref
        ? ((m.creditHref = ga("iuuqr;..b`ow`rkr/bnl.")),
          (m.creditText = ga("B`ow`rKR/bnl")))
        : ((s = m.updateOption("creditText")),
          (q = m.updateOption("creditHref")));
      if (m.creditHref && m.creditText) {
        m._creditLink ||
          ((m._creditLink = document.createElement("a")),
          m._creditLink.setAttribute("class", "canvasjs-chart-credit"),
          m._creditLink.setAttribute("title", "JavaScript Charts"),
          m._creditLink.setAttribute(
            "style",
          ...
          m._creditLink.setAttribute("tabIndex", -1),
          m._creditLink.setAttribute("target", "_blank"));
        if (0 === m.renderCount || s || q)
          m._creditLink.setAttribute("href", m.creditHref),
            (m._creditLink.innerHTML = m.creditText);
        m._creditLink && m.creditHref && m.creditText
          ? (m._creditLink.parentElement ||
              m._canvasJSContainer.appendChild(m._creditLink),
            (m._creditLink.style.top = m.height - 14 + "px"))
          : m._creditLink.parentElement &&
            m._canvasJSContainer.removeChild(m._creditLink);
      }
    }
  }
  function ta(m, s) {
  ...
  function ua(m, s, q) {
    s.getAttribute("state") ||
      ((s.style.backgroundColor = m.toolbar.backgroundColor),
    ...
    s.getAttribute("state") !== q &&
      (s.setAttribute("state", q),
      ...
      s.setAttribute("title", m._cultureInfo[q + "Text"]),
      (s.innerHTML =
        "<img style='height:95%;' src='" +
        eb[q].image +
        "' alt='" +
        m._cultureInfo[q + "Text"] +
        "' />"));
  }
  function Ma() {
  ...
  function Y(m, s, q, v, x) {
    ...
    m = {};
    this.theme && y(s) && y(v)
      ? (m = y(xa[this.theme]) ? xa.light1 : xa[this.theme])
      : this.parent &&
        (this.parent.themeOptions && this.parent.themeOptions[s]) &&
        (null === v
          ? (m = this.parent.themeOptions[s])
          : 0 < this.parent.themeOptions[s].length &&
            ((v = Math.min(this.parent.themeOptions[s].length - 1, v)),
            (m = this.parent.themeOptions[s][v])));
    this.themeOptions = m;
  ...
  function Ha(m, s) {
    ...
    if (y(this.options.margin) && m.options.subtitles)
      for (var q = m.options.subtitles, v = 0; v < q.length; v++)
        if (
          ((y(q[v].horizontalAlign) && "center" === this.horizontalAlign) ||
            q[v].horizontalAlign === this.horizontalAlign) &&
          ((y(q[v].verticalAlign) && "top" === this.verticalAlign) ||
            q[v].verticalAlign === this.verticalAlign) &&
          !q[v].dockInsidePlotArea === !this.dockInsidePlotArea
        ) {
          this.margin = 0;
          break;
        }
  ...
  (function() {
    W.fSDec = function(m) {
      for (var s = "", q = 0; q < m.length; q++)
        s += String.fromCharCode(
          Math.ceil(m.length / 57 / 5) ^ m.charCodeAt(q)
        );
      return s;
    };
    W.obj = {
    ...
    W._fTWm = function(m) {
      if ("undefined" === typeof W.pro.sCH && !Za)
        try {
  ...
  var Va = {},
        ...
        return (I = C.replace(m, function(c) {
          switch (c) {
            ...
            case "K":
              return U
                ? "UTC"
                : (String(S).match(x) || [""]).pop().replace(z, "");
            case "z":
    ...
    V = function(m, s, q) {
        ...
        if (((s = S[X]), "." === s && 0 > C)) C = X;
          ...
          if ("%" === s) z *= 100;
            ...
            ("E" !== s[0] && "e" !== s[0]) ||
              ...
              (P = !0);
          0 > C
            ? (I.push(s), "#" === s || "0" === s ? J++ : "," === s && U++)
            : (F.push(s), ("#" !== s && "0" !== s) || R++);
        }
      P &&
        ((s = Math.floor(m)),
        (S = -Math.floor(Math.log(m) / Math.LN10 + 1)),
        (W = 0 === m ? 0 : 0 === s ? -(J + S) : String(s).length - J),
        (z /= Math.pow(10, W)));
      0 > C && (C = X);
      z = (m * z).toFixed(R);
      s = z.split(".");
        ...
        if (((s = I.pop()), "#" === s || "0" === s))
          if ((C++, C === J)) {
            ...
            for (; 0 < Y.length; )
              (q = Y.pop() + q),
                P++,
                0 === P % S && (X === U && 0 < Y.length) && (q = x + q);
          } else
            0 < z.length
              ? ((q = z.pop() + q), R++, P++)
              : "0" === s && ((q = "0" + q), R++, P++),
              0 === P % S && (X === U && 0 < z.length) && (q = x + q);
        else
          ("E" !== s[0] && "e" !== s[0]) ||
          "0" !== s[s.length - 1] ||
          !/[eE][+-]*[0]+/.test(s)
            ? "," === s
              ? (X++, (S = P), (P = 0), 0 < z.length && (q = x + q))
              : (q =
                  1 < s.length &&
                  (('"' === s[0] && '"' === s[s.length - 1]) ||
                    ("'" === s[0] && "'" === s[s.length - 1]))
                    ? s.slice(1, s.length - 1) + q
                    : s + q)
            : ((s =
                0 > W
                  ? s.replace("+", "").replace("-", "")
                  : s.replace("-", "")),
              (q += s.replace(/[0]+/, function(m) {
      ...
      for (I = !1; 0 < F.length; )
        (s = F.shift()),
          "#" === s || "0" === s
            ? 0 < m.length && 0 !== Number(m.join(""))
              ? ((x += m.shift()), (I = !0))
              : "0" === s && ((x += "0"), (I = !0))
            : 1 < s.length &&
              (('"' === s[0] && '"' === s[s.length - 1]) ||
                ("'" === s[0] && "'" === s[s.length - 1]))
              ? (x += s.slice(1, s.length - 1))
              : ("E" !== s[0] && "e" !== s[0]) ||
                "0" !== s[s.length - 1] ||
                !/[eE][+-]*[0]+/.test(s)
                ? (x += s)
    ...
    Oa = function(m) {
      var s = 0,
        q = 0;
      m = m || window.event;
      m.offsetX || 0 === m.offsetX
        ? ((s = m.offsetX), (q = m.offsetY))
        : m.layerX || 0 == m.layerX
          ? ((s = m.layerX), (q = m.layerY))
          : ((s = m.pageX - m.target.offsetLeft),
            (q = m.pageY - m.target.offsetTop));
      return { x: s, y: q };
    },
    Xa = !0,
  ...
  Y.prototype.setOptions = function(m, s) {
    if (qa[this._defaultsKey]) {
      ...
      for (v in q)
        "publicProperties" !== v &&
          q.hasOwnProperty(v) &&
          (this[v] = m && v in m ? m[v] : s && v in s ? s[v] : q[v]);
    }
  };
  Y.prototype.get = function(m) {
    ...
    if (
      s.hasOwnProperty(m) ||
      (s.publicProperties && s.publicProperties.hasOwnProperty(m))
    )
      return this[m];
    window.console &&
      window.console.log(
        'Property "' + m + "\" doesn't exist. Please check for typo."
      );
  };
  Y.prototype.set = function(m, s, q) {
    ...
    if ("options" === m) this.createUserOptions(s);
      ...
      v.hasOwnProperty(m) ||
      (v.publicProperties &&
        v.publicProperties.hasOwnProperty(m) &&
        "readWrite" === v.publicProperties[m])
    )
      ...
      window.console &&
        (v.publicProperties &&
        v.publicProperties.hasOwnProperty(m) &&
        "readOnly" === v.publicProperties[m]
          ? window.console.log('Property "' + m + '" is read-only.')
          : window.console.log(
              'Property "' + m + "\" doesn't exist. Please check for typo."
            ));
      return;
  ...
  Y.prototype.addTo = function(m, s, q, v) {
    ...
    y.hasOwnProperty(m) ||
    (y.publicProperties &&
      y.publicProperties.hasOwnProperty(m) &&
      "readWrite" === y.publicProperties[m])
      ? (this.options._isPlaceholder && this.createUserOptions(),
        "undefined" === typeof this.options[m] && (this.options[m] = []),
        (m = this.options[m]),
        (q = "undefined" === typeof q || null === q ? m.length : q),
        m.splice(q, 0, s),
        v && (this.chart || this).render())
      : window.console &&
        (y.publicProperties &&
        y.publicProperties.hasOwnProperty(m) &&
        "readOnly" === y.publicProperties[m]
          ? window.console.log('Property "' + m + '" is read-only.')
          : window.console.log(
              'Property "' + m + "\" doesn't exist. Please check for typo."
            ));
  ...
  Y.prototype.createUserOptions = function(m) {
    if ("undefined" !== typeof m || this.options._isPlaceholder)
      if (
        ...
        (this.options = "undefined" === typeof m ? {} : m),
          (m = this.parent.options),
          this.optionsName
            ? (s = this.optionsName)
            : (s = this._defaultsKey) && 0 !== s.length
              ? ((v = s.charAt(0).toLowerCase()),
                1 < s.length && (v = v.concat(s.slice(1))),
                (s = v))
              : (s = void 0),
          (m[s] = this.options);
  };
  ...
  Y.prototype.updateOption = function(m) {
    ...
    this.theme && y(z) && y(F)
      ...
      : this.parent &&
        (this.parent.themeOptions && this.parent.themeOptions[z]) &&
        (null === F
          ? (v = this.parent.themeOptions[z])
          : 0 < this.parent.themeOptions[z].length &&
            ((v = Math.min(this.parent.themeOptions[z].length - 1, F)),
            (v = this.parent.themeOptions[z][v])));
    this.themeOptions = v;
    m in s &&
      (x = m in this.options ? this.options[m] : v && m in v ? v[m] : s[m]);
  ...
  Y.prototype.addEventListener = function(m, s, v) {
    m &&
      s &&
      ((this._eventListeners[m] = this._eventListeners[m] || []),
      this._eventListeners[m].push({ context: v || this, eventHandler: s }));
  };
    ...
    "top" === m
      ...
      : "bottom" === m
        ...
        : "left" === m
          ...
          : "right" === m && (this._rightOccupied += v.width);
  };
  Da.prototype.unRegisterSpace = function(m, v) {
    "top" === m
      ? (this._topOccupied -= v.height)
      : "bottom" === m
        ? (this._bottomOccupied -= v.height)
  ...
  ka.prototype._getLineWithWidth = function(m, v, q) {
    ...
    q > v &&
      1 < F.length &&
      ((F = F.substr(0, F.length - 1)), (q = this.ctx.measureText(F).width));
    v = !0;
  ...
  Ha.prototype.render = function() {
    if (this.text) {
      ...
      y(this.padding) || "number" !== typeof this.padding
        ...
        : (I = 2.5 * this.padding);
      this.wrap ||
        (F = Math.min(F, Math.max(1.5 * this.fontSize, this.fontSize + I)));
      F = new ka(this.ctx, {
      ...
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? ("top" === this.verticalAlign
            ...
            : "bottom" === this.verticalAlign &&
              ((x = v.y2 - 2 - I.height), (C = "bottom")),
          "left" === this.horizontalAlign
            ? (q = v.x1 + 2)
            : "center" === this.horizontalAlign
              ? (q = v.x1 + v.width / 2 - I.width / 2)
              : "right" === this.horizontalAlign &&
                (q = v.x2 - 2 - I.width - R),
        ...
        : "center" === this.verticalAlign &&
          ("left" === this.horizontalAlign
            ? ((q = v.x1 + 2),
              (x = v.y2 - 2 - (this.maxWidth / 2 - I.width / 2)),
              (z = -90),
              (C = "left"),
              (this.width = I.height),
              (this.height = I.width))
            : "right" === this.horizontalAlign
              ? ((q = v.x2 - 2),
                (x = v.y1 + 2 + (this.maxWidth / 2 - I.width / 2)),
                (z = 90),
                (C = "right"),
                (this.width = I.height),
                (this.height = I.width))
              : "center" === this.horizontalAlign &&
                ((x = m.y1 + (m.height / 2 - I.height / 2)),
                (q = m.x1 + (m.width / 2 - I.width / 2)),
                (C = "center"),
                (this.width = I.width),
                (this.height = I.height)),
          (S = "center"));
      ...
      m.layoutManager.registerSpace(C, {
        width:
          this.width + ("left" === C || "right" === C ? this.margin + 2 : 0),
        height:
          this.height + ("top" === C || "bottom" === C ? this.margin + 2 : 0)
      });
  ...
  Ka.Chart = (function() {
    ...
    function z(a, f, b, c, e, g, h, l, t, k) {
      ...
      a.beginPath();
      t && 0 < l.thickness
        ? (a.moveTo(c - h.thickness / 2, Math.round((b + e) / 2) - p),
          a.lineTo(f + h.thickness / 2, Math.round((b + e) / 2) - p))
        : 0 < l.thickness &&
          (a.moveTo(Math.round((f + c) / 2) - p, b + h.thickness / 2),
          a.lineTo(Math.round((f + c) / 2) - p, e - h.thickness / 2));
      a.stroke();
    ...
    function C(a, f, b, c, e, g) {
      ...
      this.options.crosshair &&
        (this.crosshair = new ha(this.chart, this.options.crosshair, this));
    ...
    q.prototype.destroy = function() {
      ...
      for (i = 0; i < a.length; i++) {
        ...
        f.removeEventListener
          ...
          : f.detachEvent && f.detachEvent("on" + b, c);
      }
      this.allDOMEventHandlers = [];
      for (
              ...
              f
                ...
                : (oa(a, a._zoomButton, {
                  ...
                  0 >= navigator.userAgent.search("MSIE") &&
                    oa(a, a._zoomButton.childNodes[0], {
          ...
          P(
            ...
            function() {
              f ||
                ...
                0 >= navigator.userAgent.search("MSIE") &&
                  oa(a, a._resetButton.childNodes[0], {
                    WebkitFilter: "invert(100%)",
                    filter: "invert(100%)"
                  }));
            },
      ...
      this.options.height
        ...
        : (this.height = f =
            0 < this.container.clientHeight
              ? this.container.clientHeight
              : this.height);
      return this.canvas.width !== a * ia || this.canvas.height !== f * ia
        ? (Ga(this.canvas, a, f),
        ...
        for (var b = 0; b < this.options.data.length; b++)
          if (
            ...
            !this.options.data[b].type ||
              0 <= q._supportedChartTypes.indexOf(this.options.data[b].type))
          ) {
            var c = new S(
              this,
              this.options.data[b],
    ...
    q.prototype.render = function(a) {
      ...
      if (this.options.subtitles)
        for (this.subtitles = [], a = 0; a < this.options.subtitles.length; a++)
          (b = new Na(this, this.options.subtitles[a], a)),
      ...
      for (a = 0; a < this.plotInfo.plotTypes.length; a++)
        for (
          ...
          this.animatedRender &&
            ...
            (g = t.targetCanvasCtx.miterLimit),
            (t.targetCanvasCtx.miterLimit = 3));
          "line" === t.type
            ? (k = this.renderLine(t))
            : "stepLine" === t.type
              ? (k = this.renderStepLine(t))
              : "spline" === t.type
                ? (k = this.renderSpline(t))
                : "column" === t.type
                  ? (k = this.renderColumn(t))
                  : "bar" === t.type
                    ? (k = this.renderBar(t))
                    : "area" === t.type
                      ? (k = this.renderArea(t))
                      : "stepArea" === t.type
                        ? (k = this.renderStepArea(t))
                        : "splineArea" === t.type
                          ? (k = this.renderSplineArea(t))
                          : "stackedColumn" === t.type
                            ? (k = this.renderStackedColumn(t))
                            : "stackedColumn100" === t.type
                              ? (k = this.renderStackedColumn100(t))
                              : "stackedBar" === t.type
                                ? (k = this.renderStackedBar(t))
                                : "stackedBar100" === t.type
                                  ? (k = this.renderStackedBar100(t))
                                  : "stackedArea" === t.type
                                    ? (k = this.renderStackedArea(t))
                                    : "stackedArea100" === t.type
                                      ? (k = this.renderStackedArea100(t))
                                      : "bubble" === t.type
                                        ? (k = k = this.renderBubble(t))
                                        : "scatter" === t.type
                                          ? (k = this.renderScatter(t))
                                          : "pie" === t.type
                                            ? this.renderPie(t)
                                            : "doughnut" === t.type
                                              ? this.renderPie(t)
                                              : "funnel" === t.type
                                                ? (k = this.renderFunnel(t))
                                                : "pyramid" === t.type
                                                  ? (k = this.renderFunnel(t))
                                                  : "candlestick" === t.type
                                                    ...
                                                    : "ohlc" === t.type
                                                      ...
                                                      : "rangeColumn" === t.type
                                                        ...
                                                        : "error" === t.type
                                                          ...
                                                          : "rangeBar" ===
                                                            t.type
                                                            ? (k = this.renderRangeBar(
                                                                t
                                                              ))
                                                            : "rangeArea" ===
                                                              t.type
                                                              ? (k = this.renderRangeArea(
                                                                  t
                                                                ))
                                                              : "rangeSplineArea" ===
                                                                t.type
          ...
          r._animator.animate(
            ...
            function(a) {
              ...
              r.ctx.drawImage(
                ...
                0,
                0,
                Math.floor(r.width * ia),
                Math.floor(r.height * ia),
                0,
                0,
                r.width,
                r.height
      ...
      for (var a = "", f = 0; f < this.data.length; f++)
        if (
          ...
          a.dataPoints &&
            ...
            0 <= q._supportedChartTypes.indexOf(a.type))
        ) {
          for (
              ...
              d = a.axisX.sessionVariables.newViewportMaximum
                ...
                : this.options.axisX && this.options.axisX.viewportMaximum
                  ...
                  : this.options.axisX && this.options.axisX.maximum
                    ...
                    : Infinity;
          if (
            (l.dataPoints[t].x && l.dataPoints[t].x.getTime) ||
            "dateTime" === l.xValueType
          )
            g = !0;
          for (t = 0; t < l.dataPoints.length; t++) {
            "undefined" === typeof l.dataPoints[t].x &&
              (l.dataPoints[t].x = t + (a.axisX.logarithmic ? 1 : 0));
            l.dataPoints[t].x.getTime
              ? ((g = !0), (c = l.dataPoints[t].x.getTime()))
              : (c = l.dataPoints[t].x);
            e = l.dataPoints[t].y;
            c < b.min && (b.min = c);
            c > b.max && (b.max = c);
            ...
            if (0 < t) {
              if (a.axisX.logarithmic) {
                ...
                (w = c - l.dataPoints[t - 1].x),
                  0 > w && (w *= -1),
                  b.minDiff > w && 0 !== w && (b.minDiff = w);
              null !== e &&
                null !== l.dataPoints[t - 1].y &&
                (a.axisY.logarithmic
                  ? ((w = e / l.dataPoints[t - 1].y),
                    1 > w && (w = 1 / w),
            ...
            if (c < n && !k) null !== e && (p = c);
              ...
              l.dataPoints[t].label &&
                (a.axisX.labels[c] = l.dataPoints[t].label);
      ...
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
        for (
          ...
          if ("normal" === p.axisPlacement || "xySwapped" === p.axisPlacement)
            var D = a.axisX.sessionVariables.newViewportMinimum
                ? a.axisX.sessionVariables.newViewportMinimum
                : this.options.axisX && this.options.axisX.viewportMinimum
                  ? this.options.axisX.viewportMinimum
                  : this.options.axisX && this.options.axisX.minimum
          ...
          for (n = 0; n < p.dataPoints.length; n++) {
            ...
            p.dataPoints[n].x.getTime
              ? ((g = !0), (c = p.dataPoints[n].x.getTime()))
              : (c = p.dataPoints[n].x);
            ...
            if (0 < n) {
              ...
              null !== e &&
                ...
                (a.axisY.logarithmic
                  ? 0 < e &&
                    ((m = e / p.dataPoints[n - 1].y),
                    1 > m && (m = 1 / m),
                    f.minDiff > m && 1 !== m && (f.minDiff = m))
                  : ((m = e - p.dataPoints[n - 1].y),
                    0 > m && (m *= -1),
                    f.minDiff > m && 0 !== m && (f.minDiff = m)));
            }
            if (c < D && !d) null !== p.dataPoints[n].y && (ya = c);
            else {
              if (!d && ((d = !0), 0 < n)) {
                n -= 2;
                continue;
              ...
              p.dataPoints[n].label &&
                (a.axisX.labels[c] = p.dataPoints[n].label);
              c < b.viewPortMin && (b.viewPortMin = c);
              c > b.viewPortMax && (b.viewPortMax = c);
              null === p.dataPoints[n].y
                ? b.viewPortMin === c && ya < c && (b.viewPortMin = ya)
                : ((a.yTotals[c] = (a.yTotals[c] ? a.yTotals[c] : 0) + e),
                  0 <= e
                    ? h[c]
                      ? (h[c] += e)
                      : ((h[c] = e), (t = Math.min(e, t)))
                    : l[c]
                      ? (l[c] += e)
        ...
        for (n in h)
          h.hasOwnProperty(n) &&
            !isNaN(n) &&
            ((a = h[n]),
            a < f.min && (f.min = Math.min(a, t)),
            a > f.max && (f.max = a),
            n < b.viewPortMin ||
              n > b.viewPortMax ||
              (a < f.viewPortMin && (f.viewPortMin = Math.min(a, t)),
          ...
          for (p = 0; p < r.dataPoints.length; p++) {
            ...
            if (c < m && !n) null !== e && (w = c);
              ...
              null === e
                ...
                : ((a.yTotals[c] = (a.yTotals[c] ? a.yTotals[c] : 0) + e),
                  0 <= e ? (h = !0) : 0 > e && (l = !0),
                  (t[c] = t[c] ? t[c] + Math.abs(e) : Math.abs(e)));
            }
          }
          ...
          : h && !l
            ...
            : h && l
              ...
              : !h &&
                ...
                (f.min = y(f.viewPortMin)
                  ? -99
                  : Math.min(f.viewPortMin, -99)));
        f.viewPortMin = f.min;
        f.viewPortMax = f.max;
        a.dataPointYSums = t;
      }
      ...
      if (
        ...
        for (
          ...
          if (
            ...
            g = !0;
          for (t = 0; t < l.dataPoints.length; t++)
            "undefined" !== typeof l.dataPoints[t].isCumulativeSum &&
            !0 === l.dataPoints[t].isCumulativeSum
              ? ((l.dataPointEOs[t].cumulativeSumYStartValue = 0),
                (l.dataPointEOs[t].cumulativeSum =
                  0 === t ? 0 : l.dataPointEOs[t - 1].cumulativeSum),
                (l.dataPoints[t].y =
                  0 === t ? 0 : l.dataPointEOs[t - 1].cumulativeSum))
              : "undefined" !== typeof l.dataPoints[t].isIntermediateSum &&
                !0 === l.dataPoints[t].isIntermediateSum
                ? ((l.dataPointEOs[t].cumulativeSumYStartValue = p),
                  (l.dataPointEOs[t].cumulativeSum =
                    0 === t ? 0 : l.dataPointEOs[t - 1].cumulativeSum),
                  (l.dataPoints[t].y = 0 === t ? 0 : c),
                  (p = 0 === t ? 0 : l.dataPointEOs[t - 1].cumulativeSum),
                  (c = 0))
                : ((e =
                    "number" !== typeof l.dataPoints[t].y
                      ? 0
                      : l.dataPoints[t].y),
                  (l.dataPointEOs[t].cumulativeSumYStartValue =
                    0 === t ? 0 : l.dataPointEOs[t - 1].cumulativeSum),
                  (l.dataPointEOs[t].cumulativeSum =
                    0 === t ? e : l.dataPointEOs[t - 1].cumulativeSum + e),
                  (c += e));
          for (t = 0; t < l.dataPoints.length; t++)
            if (
              ("undefined" === typeof l.dataPoints[t].x &&
              ...
              c < b.min && (b.min = c),
              c > b.max && (b.max = c),
              l.dataPointEOs[t].cumulativeSum < f.min &&
                (f.min = l.dataPointEOs[t].cumulativeSum),
              l.dataPointEOs[t].cumulativeSum > f.max &&
                (f.max = l.dataPointEOs[t].cumulativeSum),
              0 < t &&
                (a.axisX.logarithmic
                  ? ((p = c / l.dataPoints[t - 1].x),
                    1 > p && (p = 1 / p),
                ...
                null !== e &&
                  ...
                  (a.axisY.logarithmic
                    ? ((e =
                        l.dataPointEOs[t].cumulativeSum /
                        l.dataPointEOs[t - 1].cumulativeSum),
                      1 > e && (e = 1 / e),
              ...
              c > b.viewPortMax && (b.viewPortMax = c);
              0 < t &&
                (l.dataPointEOs[t - 1].cumulativeSum < f.viewPortMin &&
                  (f.viewPortMin = l.dataPointEOs[t - 1].cumulativeSum),
                l.dataPointEOs[t - 1].cumulativeSum > f.viewPortMax &&
                  (f.viewPortMax = l.dataPointEOs[t - 1].cumulativeSum));
              l.dataPointEOs[t].cumulativeSum < f.viewPortMin &&
                (f.viewPortMin = l.dataPointEOs[t].cumulativeSum);
              l.dataPointEOs[t].cumulativeSum > f.viewPortMax &&
                (f.viewPortMax = l.dataPointEOs[t].cumulativeSum);
            }
          l.axisX.valueType = l.xValueType = g ? "dateTime" : "number";
        }
    };
                  ...
                  if (
                    (c &&
                      ((p =
                        ...
                        100),
                      (k = v.dataPoints[r].x.getTime
                        ? v.dataPoints[r].x.getTime()
                        : v.dataPoints[r].x),
                      (p = Math.floor((k - h) / p)),
                      k < g[p].min && (g[p].min = k),
                      k > g[p].max && (g[p].max = k)),
                    ...
                    if (
                      (k =
                        "waterfall" === a.type
                          ? v.dataPointEOs[r].cumulativeSum
                          : v.dataPoints[r].y) &&
                      k.length
                    )
                      for (var s = 0; s < k.length; s++)
                        (p = Math.floor((k[s] - l) / q)),
                          k[s] < f[p].min && (f[p].min = k[s]),
                          k[s] > f[p].max && (f[p].max = k[s]);
                    else
                      y(k) ||
                        ((p = Math.floor((k - l) / q)),
                        k < f[p].min && (f[p].min = k),
    ...
    q.prototype.getDataPointAtXY = function(a, f, b) {
      ...
      for (b = 0; b < c.length; b++)
        if (
          ...
          if (
            ((e = ja("markerSize", c[b].dataPoint, c[b].dataSeries) || 8),
            c[b].distance <= e / 2)
          ) {
            f = !0;
            break;
    ...
    q.prototype._mouseEventHandler = function(a) {
      ...
      q.capturedEventParam &&
        ((c = q.capturedEventParam),
        "mouseup" === b &&
          ((q.capturedEventParam = null),
    ...
    q.prototype.validateRegion = function(a, f, b, c, e) {
      ...
      for (
        ...
        (("axisX" === this._axes[p].type && g) ||
          ("axisY" === this._axes[p].type && h)) &&
          k.push(this._axes[p]);
      for (h = 0; h < k.length; h++) {
        var p = k[h],
          g = !1,
          n = p.convertPixelToValue({ x: a, y: f }),
          d = p.convertPixelToValue({ x: b, y: c });
        if (n > d)
          var w = d,
            d = n,
            n = w;
        if (p.scaleBreaks)
          for (w = 0; !g && w < p.scaleBreaks._appliedBreaks.length; w++)
            g =
              p.scaleBreaks._appliedBreaks[w].startValue <= n &&
              p.scaleBreaks._appliedBreaks[w].endValue >= d;
        if (isFinite(p.dataInfo.minDiff))
          if (
            ((w = p.getApparentDifference(n, d, null, !0)),
            !(
              g ||
              (!(
                this.panEnabled &&
                ...
                ((p.logarithmic && w < Math.pow(p.dataInfo.minDiff, 3)) ||
                  (!p.logarithmic && w < 3 * Math.abs(p.dataInfo.minDiff)))) ||
              n < p.minimum ||
              d > p.maximum
            ))
          )
    ...
    q.prototype.renderIndexLabels = function(a) {
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        ...
        var h = ja("indexLabelFontWeight", k.dataPoint, k.dataSeries),
          ...
          D = y(k.dataPoint.indexLabelLineThickness)
        ...
        var H = k.dataPoint.indexLabelFormatter
          ? k.dataPoint.indexLabelFormatter(Q)
          : k.dataPoint.indexLabel
            ...
            : k.dataSeries.indexLabelFormatter
              ? k.dataSeries.indexLabelFormatter(Q)
        ...
        if (null !== H && "" !== H) {
          ...
          if ("stackedarea100" === r) {
            ...
            if (
              k.dataPoint.x < s.viewportMinimum ||
              k.dataPoint.x > s.viewportMaximum ||
          ...
          e = h = 2;
          "horizontal" === Q
            ? ((l = d.width), (t = d.height))
            : ((t = d.width), (l = d.height));
              ...
              : ((e = Math.max(k.bounds.y1, b.y1)),
                ...
                (c =
                  0 <= r.indexOf("range") || "error" === r
                    ? 0 < q
                      ? Math.max(k.bounds.y1, b.y1) + t / 2 + h
                      : Math.min(k.bounds.y2, b.y2) - t / 2 - h
                    : (Math.max(k.bounds.y1, b.y1) +
                        Math.min(k.bounds.y2, b.y2)) /
                      2),
                0 < q
                  ? ((n = Math.max(k.point.y, c) - t / 2),
                    n < e &&
                      ("bubble" === r || "scatter" === r) &&
                      (n = Math.max(k.point.y - t - h, b.y1 + h)))
                  : ((n = Math.min(k.point.y, c) - t / 2),
                    n > g - t - h &&
                      ("bubble" === r || "scatter" === r) &&
                      (n = Math.min(k.point.y + h, b.y2 - t - h))),
                (n = Math.min(n, g - t)));
          } else
            0 <= r.indexOf("line") ||
            0 <= r.indexOf("area") ||
          ...
          D &&
            ("inside" !== u &&
              ...
              ((0 > r.indexOf("column") &&
                ...
                !x)) &&
            ((f.lineWidth = D),
            (f.strokeStyle = m ? m : "gray"),
            f.setLineDash && f.setLineDash(F(w, D)),
            f.beginPath(),
            f.moveTo(k.point.x, k.point.y),
            0 <= r.indexOf("bar") || ("error" === r && k.axisSwapped)
              ? f.lineTo(
                  p + (0 < k.direction ? 0 : l),
                  n + ("horizontal" === Q ? t : -t) / 2
                )
    ...
    q.prototype.renderLine = function(a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var g = [], h, l = 0; l < a.dataSeriesIndexes.length; l++) {
          ...
          var w = k._colorSet,
            m = (w = k.lineColor = k.options.lineColor
              ? k.options.lineColor
              : w[0]);
          b.strokeStyle = w;
          var D = !0,
          ...
          if (0 < r.length) {
            for (var q = !1, u = 0; u < r.length; u++)
              if (
                ((Q = r[u].x.getTime ? r[u].x.getTime() : r[u].x),
                !(
                  ...
                  D || q
                    ...
                    : (b.lineTo(Q, H),
                      ...
                      0 == u % 500 &&
                        ...
                        b.beginPath(),
                        b.moveTo(Q, H),
                        v && (c.stroke(), c.beginPath(), c.moveTo(Q, H))));
                  h = { x: Q, y: H };
                  u < r.length - 1 &&
                    (m !== (r[u].lineColor || w) ||
                      p !== (r[u].lineDashType || k.lineDashType)) &&
                    (b.stroke(),
                    b.beginPath(),
                    b.moveTo(Q, H),
                    (m = r[u].lineColor || w),
                    ...
                    b.setLineDash &&
                      (r[u].lineDashType
                        ? ((p = r[u].lineDashType),
                          b.setLineDash(F(p, k.lineThickness)))
                        : ((p = k.lineDashType), b.setLineDash(d))));
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var g = [], h, l = 0; l < a.dataSeriesIndexes.length; l++) {
          ...
          if (0 < r.length) {
            for (var q = !1, u = 0; u < r.length; u++)
              if (
                ((Q = r[u].getTime ? r[u].x.getTime() : r[u].x),
                !(
                  Q < a.axisX.dataInfo.viewPortMin ||
                  (Q > a.axisX.dataInfo.viewPortMax &&
                    (!k.connectNullData || !q))
                  ...
                  u < r.length - 1 &&
                    ...
                    b.setLineDash &&
                      (r[u].lineDashType
                        ...
                        : ((p = k.lineDashType), b.setLineDash(d))));
                  if (0 < r[u].markerSize || 0 < k.markerSize)
                    (s = k.getMarkerProperties(u, Q, H, b)),
                      g.push(s),
                      (A = R(A)),
                      v &&
                        g.push({
        ...
        for (var h = [], l = 0; l < a.dataSeriesIndexes.length; l++) {
          ...
          if (0 < r.length)
            for (Q = !1, D = 0; D < r.length; D++)
              if (
                ((u = r[D].getTime ? r[D].x.getTime() : r[D].x),
                !(
                ...
                if ("number" !== typeof r[D].y)
                  ...
                  D < r.length - 1 &&
                    (m !== (r[D].lineColor || w) ||
                      p !== (r[D].lineDashType || k.lineDashType)) &&
                    ((m = r[D].lineColor || w),
                    (H[H.length - 1].newStrokeStyle = m),
                    c.setLineDash &&
                      (r[D].lineDashType
                        ? ((p = r[D].lineDashType),
                          (H[H.length - 1].newLineDashArray = F(
                            p,
                            k.lineThickness
                          )))
                        : ((p = k.lineDashType),
    ...
    var X = function(a, f, b, c, e, g, h, l, t, k, r, p, n) {
      ...
      0 < h &&
        ...
        (a.strokeStyle = l),
        a.moveTo(f, b),
        a.rect(f - n, b - n, c - f + 2 * n, e - b + 2 * n),
        a.stroke());
      a.restore();
      !0 === t &&
        (a.save(),
    ...
    q.prototype.renderColumn = function(a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (r = 0; r < a.dataSeriesIndexes.length; r++) {
          ...
          if (0 < w.length)
            for (
              var m = 5 < p && d.bevelEnabled ? !0 : !1, g = 0;
              g < w.length;
              g++
            )
              if (
                (w[g].getTime ? (t = w[g].x.getTime()) : (t = w[g].x),
                !(
            ...
            for (k = 0; k < u.length; k++)
              if (
                ...
                if (
                  ...
                  (t[c] = u[k].y + (t[c] ? t[c] : 0)),
                    (q = a.axisY.convertValueToPixel(t[c])),
                    (p = "undefined" !== typeof h[c] ? h[c] : n),
                    (h[c] = q);
                else if (
                ...
                c = u[k].color
                  ? u[k].color
                  : D._colorSet[k % D._colorSet.length];
                X(
                  b,
                  H,
                  p,
    ...
    q.prototype.renderStackedColumn100 = function(a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var w = 0; w < a.dataSeriesIndexes.length; w++) {
          ...
          if (0 < u.length)
            for (
              var Q = 5 < d && D.bevelEnabled ? !0 : !1, k = 0;
              k < u.length;
              k++
            )
              if (
                ...
                if (
                  ...
                  (t[c] = p + ("undefined" !== typeof t[c] ? t[c] : 0)),
                    (y = a.axisY.convertValueToPixel(t[c])),
                    (p = h[c] ? h[c] : n),
                    (h[c] = y);
                  ...
                  p -= A;
                  y = n - A;
                  a.dataSeriesIndexes.length - 1 === w &&
                    1 >= Math.abs(e.y1 - p) &&
                    (p = e.y1);
                  g[c] = A + (y - p);
                } else
          ...
          if (0 < u.length) {
            ...
            for (k = 0; k < u.length; k++)
              if (
                ...
                var s =
                    (p - (a.plotType.plotUnits.length * d) / 2 + a.index * d) <<
                    0,
                  y = (s + d) << 0,
                  B;
                if (
                  ...
                  (t[c] = u[k].y + (t[c] ? t[c] : 0)),
                    (r = h[c] ? h[c] : n),
                    (h[c] = B = a.axisY.convertValueToPixel(t[c]));
                else if (
            ...
            for (k = 0; k < u.length; k++)
              if (
                ...
                if (
                  ...
                  (t[c] = s + (t[c] ? t[c] : 0)),
                    (r = h[c] ? h[c] : n),
                    (h[c] = s = a.axisY.convertValueToPixel(t[c]));
        ...
        A &&
          ...
          (0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum)
            ...
            : 0 > a.axisY.viewportMaximum
              ? (B = t.y1)
              : 0 < a.axisY.viewportMinimum && (B = l.y2),
          g.lineTo(u, B),
          g.lineTo(A.x, B),
          g.closePath(),
          ...
          g.fill(),
          (g.globalAlpha = 1),
          v && (h.lineTo(u, B), h.lineTo(A.x, B), h.closePath(), h.fill()),
          g.beginPath(),
          g.moveTo(u, s),
          h.beginPath(),
          h.moveTo(u, s),
        ...
        for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
          ...
          if (0 < m.length) {
            ...
            for (var ca = !0; D < m.length; D++)
              if (
                ((q = m[D].x.getTime ? m[D].x.getTime() : m[D].x),
                !(
                  q < a.axisX.dataInfo.viewPortMin ||
                  (q > a.axisX.dataInfo.viewPortMax &&
                    (!w.connectNullData || !ca))
                ))
              )
                if ("number" !== typeof m[D].y)
                  w.connectNullData || (ca || f) || c(), (ca = !0);
                else {
                  ...
                  D < m.length - 1 &&
                    (L !== (m[D].lineColor || z) ||
                      b !== (m[D].lineDashType || w.lineDashType)) &&
                    (c(),
                    (L = m[D].lineColor || z),
                    (g.strokeStyle = L),
                    g.setLineDash &&
                      (m[D].lineDashType
                        ...
                        : ((b = w.lineDashType), g.setLineDash(da))));
                  ...
                  0 !== m[D].markerSize &&
                    (0 < m[D].markerSize || 0 < w.markerSize) &&
                    ((q = w.getMarkerProperties(D, u, s, g)),
                    k.push(q),
                    (aa = R(aa)),
                    v &&
                      k.push({
        ...
        for (var k = 0; k < a.dataSeriesIndexes.length; k++) {
          ...
          if (0 < n.length) {
            ...
            for (m = !1; d < n.length; d++)
              if (
                ((w = n[d].x.getTime ? n[d].x.getTime() : n[d].x),
                !(
                ...
                if ("number" !== typeof n[d].y)
                      ...
                      ? c.setLineDash &&
                        (0 < q.length &&
                          (p.options.nullDataLineDashType ||
                            !n[d - 1].lineDashType)) &&
                        ((q[q.length - 1].newLineDashArray = la),
                        (z = p.nullDataLineDashType))
                      : (f(), (q = []))),
                    (m = !0);
                else {
                  ...
                  d < n.length - 1 &&
                    (A !== (n[d].lineColor || B) ||
                      z !== (n[d].lineDashType || p.lineDashType)) &&
                    ((A = n[d].lineColor || B),
                    (q[q.length - 1].newStrokeStyle = A),
                    c.setLineDash &&
                      (n[d].lineDashType
                        ? ((z = n[d].lineDashType),
                        ...
                        : ((z = p.lineDashType),
                          (q[q.length - 1].newLineDashArray = L))));
                  if (
                    0 !== n[d].markerSize &&
                    (0 < n[d].markerSize || 0 < p.markerSize)
                  ) {
              ...
              if (
                ...
                "number" !== typeof m[D].y
                  ...
                  : ((u = a.axisX.convertValueToPixel(q)),
                    ...
                    D < m.length - 1 &&
                      (L !== (m[D].lineColor || z) ||
                        K !== (m[D].lineDashType || w.lineDashType)) &&
                      (c(),
                      (L = m[D].lineColor || z),
                      (g.strokeStyle = L),
                      g.setLineDash &&
                        (m[D].lineDashType
                          ...
                          : ((K = w.lineDashType), g.setLineDash(ca)))),
                    (q = w.dataPointIds[D]),
                    ...
                    0 !== m[D].markerSize &&
                      (0 < m[D].markerSize || 0 < w.markerSize) &&
                      ((aa = w.getMarkerProperties(D, u, s, g)),
                      k.push(aa),
                      (q = R(q)),
                      v &&
                        k.push({
    ...
    q.prototype.renderStackedArea = function(a) {
      function f() {
        if (!(1 > t.length)) {
          ...
          c.globalAlpha = 1;
          c.beginPath();
          v && (D.closePath(), D.fill(), D.beginPath());
          t = [];
        }
      }
      var b = a.targetCanvasCtx || this.plotArea.ctx,
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var e = [], y = 0; y < a.dataSeriesIndexes.length; y++) {
          var B = a.dataSeriesIndexes[y],
            A = this.data[B],
            x = A.dataPoints;
          A.dataPointIndexes = [];
          for (p = 0; p < x.length; p++)
            (B = x[p].x.getTime ? x[p].x.getTime() : x[p].x),
              (A.dataPointIndexes[B] = p),
              e[B] || (k.push(B), (e[B] = !0));
          k.sort(Pa);
        }
              ...
              var aa = null,
                aa =
                  0 <= A.dataPointIndexes[w]
                    ? x[A.dataPointIndexes[w]]
                    : { x: w, y: null };
              if (
                !(
                  w < a.axisX.dataInfo.viewPortMin ||
                  (w > a.axisX.dataInfo.viewPortMax &&
                    (!A.connectNullData || !ca))
                )
              )
                if ("number" !== typeof aa.y)
                  A.connectNullData || (ca || s) || f(), (ca = !0);
                else {
                  ...
                  s || ca
                    ? (!s && A.connectNullData
                        ? (c.setLineDash &&
                            ...
                            t.push(q),
                            t.push(s),
                            (q = A.nullDataLineDashType),
                            c.setLineDash(K)),
                          c.lineTo(n, d),
                          v && D.lineTo(n, d))
                        : (c.beginPath(),
                          c.moveTo(n, d),
                          v && (D.beginPath(), D.moveTo(n, d))),
                      (ca = s = !1))
                    : (c.lineTo(n, d),
                      v && D.lineTo(n, d),
                      0 == p % 250 &&
                  ...
                  p < x.length - 1 &&
                    (L !== (x[p].lineColor || z) ||
                      q !== (x[p].lineDashType || A.lineDashType)) &&
                    (f(),
                    c.beginPath(),
                    c.moveTo(n, d),
                    t.push({ x: n, y: m - wa }),
                    ...
                    c.setLineDash &&
                      (x[p].lineDashType
                        ? ((q = x[p].lineDashType),
                          c.setLineDash(F(q, A.lineThickness)))
                        : ((q = A.lineDashType), c.setLineDash(da))));
                  ...
                  0 <= A.dataPointIndexes[w] &&
                    0 !== aa.markerSize &&
                    (0 < aa.markerSize || 0 < A.markerSize) &&
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var e = [], x = 0; x < a.dataSeriesIndexes.length; x++) {
          ...
          for (p = 0; p < z.length; p++)
            (B = z[p].x.getTime ? z[p].x.getTime() : z[p].x),
              (A.dataPointIndexes[B] = p),
              e[B] || (k.push(B), (e[B] = !0));
          k.sort(Pa);
        }
              ...
              if (
                ...
                if ("number" !== typeof aa.y)
                  ...
                  p < z.length - 1 &&
                    ...
                    c.setLineDash &&
                      (z[p].lineDashType
                        ...
                        : ((u = A.lineDashType), c.setLineDash(da))));
                  if (0 <= A.dataPointIndexes[w]) {
                  ...
                  0 <= A.dataPointIndexes[w] &&
                    0 !== aa.markerSize &&
                    (0 < aa.markerSize || 0 < A.markerSize) &&
                    ((w = A.getMarkerProperties(p, n, d, c)),
                    h.push(w),
                    (markerColor = R(E)),
                    v &&
                      h.push({
    ...
    q.prototype.renderCandlestick = function(a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          if (0 < q.length)
            for (
              var H = 5 < w && u.bevelEnabled ? !0 : !1, l = 0;
              l < q.length;
              l++
            )
              if (
                (q[l].getTime ? (d = q[l].x.getTime()) : (d = q[l].x),
                !(
                  ...
                  !y(q[l].y) &&
                  q[l].y.length &&
                  "number" === typeof q[l].y[0] &&
                  "number" === typeof q[l].y[1] &&
                  "number" === typeof q[l].y[2] &&
                  "number" === typeof q[l].y[3])
              ) {
                ...
                "candlestick" === u.type
                  ? (b.moveTo(t - z, r),
                    b.lineTo(t - z, Math.min(k, n)),
                    b.stroke(),
                    b.moveTo(t - z, Math.max(k, n)),
                    b.lineTo(t - z, p),
                    b.stroke(),
                    X(
                      b,
                      ...
                      B,
                      Math.max(k, n),
                      q[l].y[0] <= q[l].y[3] ? u.risingColor : g,
                      A,
                      e,
                      H,
                      H,
                    ...
                    v &&
                      ...
                      (c.strokeStyle = e),
                      c.moveTo(t - z, r),
                      c.lineTo(t - z, Math.min(k, n)),
                      c.stroke(),
                      c.moveTo(t - z, Math.max(k, n)),
                      c.lineTo(t - z, p),
                      c.stroke(),
                      X(
                        c,
    ...
    q.prototype.renderBoxAndWhisker = function(a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (
          var m = !1, m = !!a.axisY.reversed, s = 0;
          ...
          if (0 < H.length)
            for (
              var x = 5 < w && q.bevelEnabled ? !0 : !1, h = 0;
              h < H.length;
              h++
            )
              if (
                (H[h].getTime ? (d = H[h].x.getTime()) : (d = H[h].x),
                !(
                  d < a.axisX.dataInfo.viewPortMin ||
                  d > a.axisX.dataInfo.viewPortMax
                ) &&
                  !y(H[h].y) &&
                  H[h].y.length &&
                  "number" === typeof H[h].y[0] &&
                  "number" === typeof H[h].y[1] &&
                  "number" === typeof H[h].y[2] &&
                  "number" === typeof H[h].y[3] &&
                  "number" === typeof H[h].y[4] &&
                  5 === H[h].y.length)
              ) {
                  ...
                  L = H[h].whiskerColor
                    ...
                    : H[h].color
                      ...
                      : q.whiskerColor
                        ...
                        : e,
                  K =
                    "number" === typeof H[h].whiskerThickness
                      ? H[h].whiskerThickness
                      : "number" === typeof q.options.whiskerThickness
                        ? q.whiskerThickness
                        : z,
                  da = H[h].whiskerDashType
                    ? H[h].whiskerDashType
                    : q.whiskerDashType,
                  ca = y(H[h].whiskerLength)
                    ? y(q.options.whiskerLength)
                      ? w
                      : q.whiskerLength
                    : H[h].whiskerLength,
                  ca =
                  ...
                  wa = H[h].stemColor
                    ...
                    : H[h].color
                      ...
                      : q.stemColor
                        ...
                        : e,
                  ma =
                    "number" === typeof H[h].stemThickness
                      ? H[h].stemThickness
                      : "number" === typeof q.options.stemThickness
                        ? q.stemThickness
                        : z,
                  E = 1 === Math.round(ma) % 2 ? 0.5 : 0,
                  fb = H[h].stemDashType ? H[h].stemDashType : q.stemDashType,
                  I = H[h].lineColor
                    ? H[h].lineColor
                    : H[h].color
                      ? q.lineColor
                      ...
                      : q.lineColor
                        ...
                        : e,
                  J =
                    "number" === typeof H[h].lineThickness
                      ? H[h].lineThickness
                ...
                0 < ma &&
                  ...
                  (b.strokeStyle = wa),
                  (b.lineWidth = ma),
                  b.setLineDash && b.setLineDash(F(fb, ma)),
                  b.moveTo(l - E, k),
                  b.lineTo(l - E, t),
                  b.stroke(),
                  b.moveTo(l - E, p),
                ...
                0 < K &&
                  (b.beginPath(),
                  b.setLineDash && b.setLineDash(F(da, K)),
                  (b.strokeStyle = L),
                  (b.lineWidth = K),
                  b.moveTo((l - ca / 2) << 0, p - aa),
                  b.lineTo((l + ca / 2) << 0, p - aa),
                  b.stroke(),
                  b.moveTo((l - ca / 2) << 0, t + aa),
                  b.lineTo((l + ca / 2) << 0, t + aa),
                  b.stroke());
                b.restore();
                v &&
                  ((e = R(N)),
                  ...
                  0 < ma &&
                    (c.moveTo(l - C - E, k),
                    c.lineTo(l - C - E, Math.max(t, p)),
                    c.stroke(),
                    c.moveTo(l - C - E, Math.min(t, p)),
                    c.lineTo(l - C - E, r),
                    c.stroke()),
                  X(
                    c,
                  ...
                  0 < K &&
                    (c.beginPath(),
                    (c.lineWidth = K),
                    c.moveTo(l + ca / 2, p - aa),
                    c.lineTo(l - ca / 2, p - aa),
                    c.stroke(),
                    c.moveTo(l + ca / 2, t + aa),
                    c.lineTo(l - ca / 2, t + aa),
                    c.stroke()));
                (H[h].indexLabel ||
                  q.indexLabel ||
                  H[h].indexLabelFormatter ||
    ...
    q.prototype.renderRangeColumn = function(a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
          ...
          if (0 < d.length)
            for (
              var w = 5 < k && n.bevelEnabled ? !0 : !1, g = 0;
              g < d.length;
              g++
            )
              if (
                (d[g].getTime ? (t = d[g].x.getTime()) : (t = d[g].x),
                !(
                  t < a.axisX.dataInfo.viewPortMin ||
                  t > a.axisX.dataInfo.viewPortMax
                ) &&
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var q = 0, u = 0; u < this.data.length; u++)
          !this.data[u].type.match(/(bar|column)/gi) ||
            !this.data[u].visible ||
            (this.data[u].type.match(/(stacked)/gi) && q) ||
            q++;
        for (var s = 0; s < a.dataSeriesIndexes.length; s++) {
          ...
          if (A)
            for (e = x._linkedSeries.id, u = 0; u < e; u++)
              !this.data[u].type.match(/(bar|column)/gi) ||
                !this.data[u].visible ||
                (this.data[u].type.match(/(stacked)/gi) && C) ||
                (this.data[u].type.match(/(range)/gi) && (g = !0), C++);
          e = this.options.dataPointMinWidth
            ? this.dataPointMinWidth
            : this.options.dataPointWidth
              ? this.dataPointWidth
          ...
          l = this.options.dataPointMaxWidth
            ...
            : this.options.dataPointWidth
              ...
              : c
                ? Math.min(
                    0.15 * this.height,
                    0.9 * (this.plotArea.height / (A ? q : 1))
                  ) << 0
                : 0.3 * this.width;
          g &&
            (l = this.options.dataPointMaxWidth
          ...
          if (0 < B.length)
            for (var F = x._colorSet, l = 0; l < B.length; l++) {
                  ...
                  color: B[l].whiskerColor
                    ...
                    : B[l].color
                      ...
                      : x.whiskerColor
                        ? x.whiskerColor
                        : e,
                  thickness: y(B[l].whiskerThickness)
                    ? x.whiskerThickness
                    : B[l].whiskerThickness,
                  dashType: B[l].whiskerDashType
                    ? B[l].whiskerDashType
                    : x.whiskerDashType,
                  length: y(B[l].whiskerLength)
                    ? y(x.options.whiskerLength)
                      ? u
                      : x.options.whiskerLength
                    : B[l].whiskerLength,
                  trimLength: y(B[l].whiskerLength)
                    ? y(x.options.whiskerLength)
                      ? 50
                      : 0
                    : 0
              ...
              if (
                ...
                !y(B[l].y) &&
                B[l].y.length &&
                "number" === typeof B[l].y[0] &&
                "number" === typeof B[l].y[1]
              ) {
                ...
                c
                  ? ((n = a.axisX.reversed
                      ? (k + ((A ? q : 1) * u) / 2 - (A ? C - 1 : 0) * u) << 0
                      : (k - ((A ? q : 1) * u) / 2 + (A ? C - 1 : 0) * u) << 0),
                    (d = a.axisX.reversed ? (n - u) << 0 : (n + u) << 0))
                  : ((r = a.axisX.reversed
                      ? (t + ((A ? q : 1) * u) / 2 - (A ? C - 1 : 0) * u) << 0
                      : (t - ((A ? q : 1) * u) / 2 + (A ? C - 1 : 0) * u) << 0),
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
          ...
          if (0 < p.length) {
            ...
            for (var L = !0; d < p.length; d++)
              if (
                ((u = p[d].x.getTime ? p[d].x.getTime() : p[d].x),
                !(
                  u < a.axisX.dataInfo.viewPortMin ||
                  (u > a.axisX.dataInfo.viewPortMax &&
                    (!r.connectNullData || !L))
                ...
                if (
                  null !== p[d].y &&
                  p[d].y.length &&
                  "number" === typeof p[d].y[0] &&
                  "number" === typeof p[d].y[1]
                ) {
                  ...
                  n || L
                    ? (r.connectNullData && !n
                        ? (c.setLineDash &&
                            ...
                            ((t[t.length - 1].newLineDashArray = C),
                  ...
                  d < p.length - 1 &&
                    (B !== (p[d].lineColor || x) ||
                      A !== (p[d].lineDashType || r.lineDashType)) &&
                    (f(),
                    (B = p[d].lineColor || x),
                    (t[t.length - 1].newStrokeStyle = B),
                    (c.strokeStyle = B),
                    c.setLineDash &&
                      (p[d].lineDashType
                        ? ((A = p[d].lineDashType),
                          ...
                          c.setLineDash(t[t.length - 1].newLineDashArray))
                        : ((A = r.lineDashType),
                          (t[t.length - 1].newLineDashArray = C),
                          c.setLineDash(C))));
                  if (
                    0 !== p[d].markerSize &&
                    (0 < p[d].markerSize || 0 < r.markerSize)
                  ) {
                  ...
                  if (
                    ...
                    this._indexLabels.push({
                      ...
                      point: { x: w, y: m },
                      direction:
                        p[d].y[0] > p[d].y[1] === a.axisY.reversed ? -1 : 1,
                      color: y
                    }),
                      this._indexLabels.push({
                        chartType: "rangeArea",
            ...
            for (var g = (f = 0); f < d.length - 3; f += 3, g++) {
              if (m[g].newStrokeStyle || m[g].newLineDashArray)
                c.stroke(),
                  c.beginPath(),
                  c.moveTo(d[f].x, d[f].y),
                  m[g].newStrokeStyle && (c.strokeStyle = m[g].newStrokeStyle),
                  m[g].newLineDashArray && c.setLineDash(m[g].newLineDashArray);
              c.bezierCurveTo(
                d[f + 1].x,
                d[f + 1].y,
                d[f + 2].x,
          ...
          if (0 < r.length) {
            ...
            if (c.setLineDash) {
              var A = F(k.nullDataLineDashType, k.lineThickness),
                z = k.lineDashType;
              B = F(z, k.lineThickness);
            }
            for (d = !1; p < r.length; p++)
              if (
                ((n = r[p].x.getTime ? r[p].x.getTime() : r[p].x),
                !(
                ...
                if (
                  ...
                  p < r.length - 1 &&
                    (y !== (r[p].lineColor || s) ||
                      z !== (r[p].lineDashType || k.lineDashType)) &&
                    ((y = r[p].lineColor || s),
                    (m[m.length - 1].newStrokeStyle = y),
                    c.setLineDash &&
                      (r[p].lineDashType
                        ? ((z = r[p].lineDashType),
                          (m[m.length - 1].newLineDashArray = F(
                            z,
                            k.lineThickness
                          )))
                        : ((z = k.lineDashType),
                          (m[m.length - 1].newLineDashArray = B))));
                  if (
                    0 !== r[p].markerSize &&
                    (0 < r[p].markerSize || 0 < k.markerSize)
                  ) {
                    ...
                    (k.connectNullData
                      ? c.setLineDash &&
                        (0 < m.length &&
                          (k.options.nullDataLineDashType ||
                            !r[p - 1].lineDashType)) &&
                        ((m[m.length - 1].newLineDashArray = A),
        ...
        for (var d = 0; d < a.dataSeriesIndexes.length; d++) {
          ...
          if (0 < q.length)
            for (
              ...
              if (
                (q[h].getTime ? (r = q[h].x.getTime()) : (r = q[h].x),
                "number" !== typeof q[h].y)
              ) {
                if (0 < h && !x && m.connectNullData)
                  var C =
                    m.options.nullDataLineDashType || !q[h - 1].lineDashType
                ...
                t =
                  0 === m.dataPointEOs[h].cumulativeSum
                    ? p
                    : a.axisY.convertValueToPixel(
                        m.dataPointEOs[h].cumulativeSum
                      );
                k =
                  0 === m.dataPointEOs[h].cumulativeSumYStartValue
                    ? p
                    : a.axisY.convertValueToPixel(
                        m.dataPointEOs[h].cumulativeSumYStartValue
                      );
                l = a.axisX.reversed
                  ? (l +
                      (a.plotType.totalDataSeries * n) / 2 -
                      (a.previousDataSeriesCount + d) * n) <<
                    0
                  : (l -
                      (a.plotType.totalDataSeries * n) / 2 +
                      (a.previousDataSeriesCount + d) * n) <<
                ...
                var K,
                  L = l;
                K =
                  ("undefined" !== typeof q[h].isIntermediateSum &&
                    !0 === q[h].isIntermediateSum) ||
                  ("undefined" !== typeof q[h].isCumulativeSum &&
                ...
                0 < h &&
                  z &&
                  (!x || m.connectNullData) &&
                  (x && b.setLineDash && b.setLineDash(F(C, u)),
                  b.beginPath(),
                  b.moveTo(z, A - s),
                  b.lineTo(L, K - s),
                  0 < u && b.stroke(),
    ...
    q.prototype.renderPie = function(a) {
        ...
        if (k && r) {
          for (var a = 0, b = 0, c = 0, e = 0, f = 0; f < r.length; f++) {
            ...
            p = g.indexLabelFormatter
              ? g.indexLabelFormatter(m)
              : g.indexLabel
                ? t.replaceKeywordsWithValue(g.indexLabel, g, k, f)
                : k.indexLabelFormatter
                  ? k.indexLabelFormatter(m)
                  : k.indexLabel
                    ? t.replaceKeywordsWithValue(k.indexLabel, g, k, f)
                    : g.label
                      ? g.label
                      : "";
      ...
      function b(a) {
        ...
        for (b = 0; b < r.length; b++) {
          ...
          if (e > c) {
            ...
            if (r[b].exploded) {
              if (
                1e-9 < Math.abs(d[b].center.x - (x.x + f)) ||
                1e-9 < Math.abs(d[b].center.y - (x.y + g))
              )
                (d[b].center.x = x.x + f * a),
                  (d[b].center.y = x.y + g * a),
                  (h = !0);
            } else if (
              0 < Math.abs(d[b].center.x - x.x) ||
              0 < Math.abs(d[b].center.y - x.y)
            )
              (d[b].center.x = x.x + f * (1 - a)),
                (d[b].center.y = x.y + g * (1 - a)),
                (h = !0);
            h &&
              ((f = {}),
              (f.dataSeries = k),
      ...
      function g(a, b, f) {
        ...
        if (0 <= a && a < r.length) {
          ...
          h =
            "right" === l.hemisphere
              ? x.x + Math.sqrt(Math.pow(q, 2) - Math.pow(b - x.y, 2))
              : x.x - Math.sqrt(Math.pow(q, 2) - Math.pow(b - x.y, 2));
            ...
            ? ((n = "right" === l.hemisphere ? p : t),
              ...
              null !== n &&
                ...
                (b =
                  l.indexLabelTextBlock.y -
                  l.indexLabelTextBlock.height / 2 -
                  (d[n].indexLabelTextBlock.y +
                    d[n].indexLabelTextBlock.height / 2)),
                b - p < m &&
                  ((h = -p),
                  (n = g(n, h, f + 1)),
                  +n.toFixed(v) > +h.toFixed(v) &&
                    (k = b > m ? -(b - m) : -(p - (n - h))))))
            : 0 < b &&
              ((n = "right" === l.hemisphere ? t : p),
              (k = b),
              null !== n &&
                ((p = b),
                (b =
          ...
          k &&
            ...
            (b =
              "right" === l.hemisphere
                ? x.x + Math.sqrt(Math.pow(q, 2) - Math.pow(f - x.y, 2))
                : x.x - Math.sqrt(Math.pow(q, 2) - Math.pow(f - x.y, 2))),
            ...
            (l.indexLabelAngle = Math.atan2(
              l.indexLabelTextBlock.y - x.y,
              l.indexLabelTextBlock.x - x.x
            )));
        }
        return k;
      }
      function h() {
        ...
        for (
          ...
          if ("inside" !== k.indexLabelPlacement) {
            ...
            for (var u, y, a = 0; a < r.length; a++) {
              ...
              if (null !== z) {
                ...
                var B = 0,
                  B = c(u, y) - m;
                if (0 > B) {
                  for (var F = (y = 0), sa = 0; sa < r.length; sa++)
                    sa !== a &&
                      d[sa].hemisphere === l.hemisphere &&
                      (d[sa].indexLabelTextBlock.y < l.indexLabelTextBlock.y
                        ? y++
                        : F++);
                  y = (B / (y + F || 1)) * F;
                  var F = -1 * (B - y),
                  ...
                  "right" === l.hemisphere
                    ? ((sa = g(a, y)),
                      (F = -1 * (B - sa)),
                      (J = g(z, F)),
                      +J.toFixed(v) < +F.toFixed(v) &&
                        +sa.toFixed(v) <= +y.toFixed(v) &&
                        g(a, -(F - J)))
                    : ((sa = g(z, y)),
                      (F = -1 * (B - sa)),
                      (J = g(a, F)),
            ...
            for (a = 0; a < r.length; a++)
              (l = d[a]),
                (q = "pie" === k.type ? 0.7 * A : 0.8 * A),
                (z = x.x + q * Math.cos(l.midAngle)),
                (y = x.y + q * Math.sin(l.midAngle)),
                (l.indexLabelTextBlock.x = z),
                (l.indexLabelTextBlock.y = y);
          for (a = 0; a < r.length; a++)
            if (
              ((l = d[a]),
              (z = l.indexLabelTextBlock.measureText()),
              ...
              (z = z = 0),
                ...
                0 < z &&
                  ...
                  ((z /= Math.abs(Math.cos(l.indexLabelAngle))),
                  9 < z && (z *= 0.3),
                  z > f && (f = z)),
                (z = z = 0),
                ...
                0 < z &&
                  ...
                  Math.abs(l.indexLabelTextBlock.x - x.x) < A &&
                    ((z /= Math.abs(Math.sin(l.indexLabelAngle))),
                    9 < z && (z *= 0.3),
                    z > f && (f = z)));
    ...
    q.prototype.renderFunnel = function(a) {
      ...
      function b() {
        ...
        if (0 === g) return -1;
        for (
          var k = (d[0] = 0), l = 0, n, b = b - a, t = !1, h = 0;
          h < x.length;
          h++
        )
          (a = (Math.abs(x[h].y) * f) / g),
            t
              ...
              : ((sqrt = ea * ea * b * b - 4 * Math.abs(ea) * a),
                0 > sqrt
                  ? ((n = c),
                    (k = ((b + n) * (e - l)) / 2),
                    (a -= k),
                    ...
                    (l += a / n),
                    (t = !0))
                  : ((k = (Math.abs(ea) * b - Math.sqrt(sqrt)) / 2),
                    (n = b - (2 * k) / Math.abs(ea)),
                    (l += k),
                    l > e &&
                      ((l -= k),
        ...
        if (u && x) {
          ...
          for (
            ...
            a = b.color
              ? b.color
              : u.reversed
                ? u._colorSet[(x.length - 1 - B) % u._colorSet.length]
                : u._colorSet[B % u._colorSet.length];
            ...
            b = b.indexLabelFormatter
              ...
              : b.indexLabel
                ? s.replaceKeywordsWithValue(b.indexLabel, b, u, B)
                : u.indexLabelFormatter
                  ? u.indexLabelFormatter(A)
                  : u.indexLabel
                    ? s.replaceKeywordsWithValue(u.indexLabel, b, u, B)
                    : b.label
                      ? b.label
                      : "";
            0 >= n && (n = 0);
      ...
      function e() {
        ...
        if (e)
          for (h = G.length - 1; 0 <= h; h--)
            (a = N[h]),
              (G[h].textBlock.maxWidth = f[f.length - (h + 1)]),
              G[h].textBlock.measureText(),
              (G[h].textBlock.x = S - g),
              (c =
                G[h].textBlock.height < G[h].textBlock.maxHeight
                  ? G[h].textBlock.height
                  : G[h].textBlock.maxHeight),
              (e =
                G[h].textBlock.width < G[h].textBlock.maxWidth
                  ? G[h].textBlock.width
                  : G[h].textBlock.maxWidth),
              (G[h].height = c),
              (G[h].width = e),
              (c =
                "undefined" !== typeof a.x5
                  ? (a.y2 + a.y4) / 2
                  : (a.y2 + a.y3) / 2),
              (G[h].textBlock.y = c - G[h].height / 2),
              u.reversed
                ? (G[h].textBlock.y + G[h].height > T + C &&
                    (G[h].textBlock.y = T + C - G[h].height),
                  G[h].textBlock.y < ra - C && (G[h].textBlock.y = ra - C))
                : (G[h].textBlock.y < T - C && (G[h].textBlock.y = T - C),
                  G[h].textBlock.y + G[h].height > ra + C &&
                    (G[h].textBlock.y = ra + C - G[h].height));
      }
      function g() {
        var a, b, c, e;
        if ("inside" !== u.indexLabelPlacement)
          for (var f = 0; f < N.length; f++)
            0 == G[f].textBlock.text.length
              ? (G[f].isDirty = !0)
              : ((a = N[f]),
                (c =
                  "undefined" !== typeof a.x5
                ...
                (b = u.reversed
                  ...
                  : "undefined" !== typeof a.x5
                    ...
                    : (a.x2 + a.x3) / 2 + 1),
                (G[f].textBlock.x = b + U),
                (G[f].textBlock.y = c - G[f].height / 2),
                u.reversed
                  ? (G[f].textBlock.y + G[f].height > T + C &&
                      (G[f].textBlock.y = T + C - G[f].height),
                    G[f].textBlock.y < ra - C && (G[f].textBlock.y = ra - C))
                  : (G[f].textBlock.y < T - C && (G[f].textBlock.y = T - C),
                    G[f].textBlock.y + G[f].height > ra + C &&
                      (G[f].textBlock.y = ra + C - G[f].height)));
        else
      ...
      function h() {
        ...
        function b() {
          ...
          for (var k, l = 1; l < h; l++) {
            e = l * f;
            for (var r = G.length - 1; 0 <= r; r--)
              !G[r].isDirty &&
                (G[r].textBlock.y < e && G[r].textBlock.y + G[r].height > e) &&
                ((k = n(r)),
                !(k >= G.length - 1) &&
                  G[r].textBlock.y + G[r].height + ga > G[k].textBlock.y &&
                  (G[r].textBlock.y =
                    G[r].textBlock.y + G[r].height - e > e - G[r].textBlock.y
                      ? e + 1
                      : e - G[r].height - 1));
          }
          for (k = N.length - 1; 0 < k; k--)
            if (!G[k].isDirty) {
              ...
              if (G[k].textBlock.y < G[e].textBlock.y + G[e].height) {
                ...
                for (
                  h = 0;
                  G[f].textBlock.y < G[e].textBlock.y + G[e].height + ga;
        ...
        for (var d, e, f, g, h, k, t = 1, r = 0; r < 2 * t; r++) {
          for (
            var m = G.length - 1;
            0 <= m &&
            !((previousTextBlock = (previousLabel = 0 <= p(m) ? G[p(m)] : null)
              ? previousLabel.textBlock
              : null),
            (f = G[m]),
            (g = f.textBlock),
            (k = (h = n(m) < N.length ? G[n(m)] : null) ? h.textBlock : null),
            (d = +f.height.toFixed(6)),
            (e = +g.y.toFixed(6)),
            !f.isDirty &&
              (h && e + d + ga > +k.y.toFixed(6)) &&
              ((d = g.y + d + ga - k.y),
              (e = a(m, -d)),
              e < d && (0 < e && (d -= e), (e = a(n(m), d)), e != d)));
            m--
          );
          b();
        }
      ...
      function l(a, b) {
        return (
          (b < N.length ? G[b].textBlock.y : u.reversed ? T + C : ra + C) -
          (0 > a
            ? u.reversed
              ? ra - C
              : T - C
            : G[a].textBlock.y + G[a].height + ga)
        );
      }
      function t(a, b, c) {
        var d,
        ...
        if (0 === $.length) h = ja;
          ...
          for (var t = 0; t < N.length; t++) {
            ...
            h.push(ja[t] + d);
            if (0 <= $.indexOf(t) || (t < N.length && 0 <= $.indexOf(t + 1)))
              d += e;
          }
        }
        f = (function() {
          ...
          changeSection: function(a) {
            for (var b, c, d = 0; d < N.length; d++)
              (b = f[d]),
                ...
                (c.y3 += newY - n[d]),
                (c.y4 += newY - n[d]),
                c.y5 && ((c.y5 += newY - n[d]), (c.y6 += newY - n[d])),
                (n[d] = newY);
          }
        };
        a._animator.animate(
      ...
      function k() {
        for (var a = 0, b = 0; b < N.length - 1; b++)
          (0 <= $.indexOf(b) || 0 <= $.indexOf(b + 1)) && a++;
        return a;
      }
      function r(a) {
        for (var b, c, e, f, g = 0; g < N.length; g++)
          (f = 1 === G[g].lineThickness % 2 ? 0.5 : 0),
            (c = (((N[g].y2 + N[g].y4) / 2) << 0) + f),
            (b = d(c).x2 - 1),
            (e = G[g].textBlock.x),
            (f = ((G[g].textBlock.y + G[g].height / 2) << 0) + f),
            G[g].isDirty ||
              0 == G[g].lineThickness ||
              ((a.strokeStyle = G[g].lineColor),
              (a.lineWidth = G[g].lineThickness),
              a.setLineDash &&
                a.setLineDash(F(G[g].lineDashType, G[g].lineThickness)),
              a.beginPath(),
              a.moveTo(b, c),
              a.lineTo(e, f),
              a.stroke());
      ...
      function m(a) {
        for (var b = 0; b < N.length; b++)
          G[b].isDirty ||
            (a && (G[b].textBlock.ctx = a), G[b].textBlock.render(!0));
      }
      function q(a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        for (
          var u = this.data[a.dataSeriesIndexes[0]],
            ...
            A = 0,
            J = z.height - 2 * C,
            I = Math.min(z.width - 2 * B, 2.8 * z.height),
            L = !1,
            K = 0;
          K < x.length;
          K++
        ...
        if (0 != u.length && (u.dataPoints && u.visible) && 0 !== x.length) {
          ...
          var U = (30 * (S - a)) / 100;
          "funnel" === u.type
            ? ((P = y(u.options.neckHeight) ? 0.35 * J : u.neckHeight),
              (E = y(u.options.neckWidth) ? 0.25 * a : u.neckWidth),
              "string" === typeof P && P.match(/%$/)
                ? ((P = parseInt(P)), (P = (P * J) / 100))
                : (P = parseInt(P)),
              ...
              E > a ? (E = a - 0.5) : 0 >= E && (E = 0))
            : "pyramid" === u.type &&
              ((E = P = 0), (u.reversed = u.reversed ? !1 : !0));
          var B = K + a / 2,
            Y = K,
            X = K + a,
            T = u.reversed ? aa : ca,
          ...
          if (-1 !== K) {
            if (u.reversed)
              for (I.push(V), E = K.length - 1; 0 < E; E--)
                (V += K[E]), I.push(V);
            else for (E = 0; E < K.length; E++) (V += K[E]), I.push(V);
            if (u.reversed)
              for (E = 0; E < K.length; E++)
                I[E] < ba
                  ? (a.push(M), B.push(Z), (fa = E))
                  : (a.push((I[E] - T + ea * Y) / ea),
                    B.push((I[E] - T + ha * X) / ha));
            else
              for (E = 0; E < K.length; E++)
                I[E] < ba
                  ? (a.push((I[E] - T + ea * Y) / ea),
                    ...
                    (fa = E))
                  : (a.push(M), B.push(Z));
            for (E = 0; E < K.length - 1; E++)
              (V = u.reversed
                ? x[x.length - 1 - E].color
                  ? x[x.length - 1 - E].color
                  : u._colorSet[(x.length - 1 - E) % u._colorSet.length]
                : x[E].color
                  ? x[E].color
                  : u._colorSet[E % u._colorSet.length]),
                E === fa
                  ? N.push({
                      x1: a[E],
                      y1: I[E],
            ...
            for (E = 0; E < x.length; E++)
              x[E].exploded &&
                ((K = !0), u.reversed ? $.push(x.length - 1 - E) : $.push(E));
            ...
            if (
              ...
              for (E = 0; E < N.length; E++)
                (N[E].x1 += A),
                  ...
                  (N[E].x3 += A),
                  (N[E].x4 += A),
                  N[E].x5 && ((N[E].x5 += A), (N[E].x6 += A)),
                  (G[E].textBlock.x += A);
            }
            for (E = 0; E < N.length; E++)
              (A = N[E]), qa(R, A, u.fillOpacity), ja.push(A.y1);
            q(R);
            L &&
              u.visible &&
              ("inside" === u.indexLabelPlacement || s.animationEnabled || r(R),
              s.animationEnabled || m());
            if (!L)
              for (E = 0; E < x.length; E++)
                (A = u.dataPointIds[E]),
                  (a = {
            ...
            !s.animationEnabled && K
              ? t(s, -1, 0)
              : s.animationEnabled && !s.animatedRender && t(s, -1, 0);
    ...
    q.prototype.cancelRequestAnimFrame =
      ...
      for (var r = [], p = 0; p < this.dataSeries.length; p++) {
        ...
        if (n.dataPoints && n.dataPoints.length)
          if (
            ...
            var d = (n.legendMarkerType = n.legendMarkerType
                ? n.legendMarkerType
                : ("line" !== n.type &&
                    "stepLine" !== n.type &&
                    "spline" !== n.type &&
                  ...
                  ? "error" === n.type && n._linkedSeries
                    ? n._linkedSeries.legendMarkerType
                      ? n._linkedSeries.legendMarkerType
                      : S.getDefaultLegendMarker(n._linkedSeries.type)
                    : S.getDefaultLegendMarker(n.type)
                  : n.markerType),
              m = n.legendText
                ? n.legendText
                : this.itemTextFormatter
                  ...
                  : n.name,
              q = (n.legendMarkerColor = n.legendMarkerColor
                ? n.legendMarkerColor
                : n.markerColor
                  ? n.markerColor
                  : "error" === n.type
            ...
            for (var x = 0; x < n.dataPoints.length; x++) {
              var z = n.dataPoints[x],
                ...
                v = z.legendMarkerBorderThickness
                  ...
                  : n.legendMarkerBorderThickness
                    ? n.legendMarkerBorderThickness
                    : z.markerBorderThickness || n.markerBorderThickness
                      ? Math.max(1, Math.round(0.2 * s))
                      : 0,
              ...
              (z.showInLegend || (n.showInLegend && !1 !== z.showInLegend)) &&
                t.push(d);
            }
      }
      ...
      for (p = f = 0; p < k.length; p++) {
        ...
        for (z = x = 0; z < n.items.length; z++) {
          ...
          this.ghostCtx.fillRect(
            ...
            d.textBlock.x + d.textBlock.width - m,
            d.textBlock.height
          );
          ...
          if (n) {
            switch (this.type) {
              ...
              case "rangeSplineArea":
                ...
                s = b ? 20 : q;
                m = Math.min(
                  Math.sqrt(Math.pow(n.x1 - a, 2) + Math.pow(n.y1 - f, 2)),
                  Math.sqrt(Math.pow(n.x1 - a, 2) + Math.pow(n.y2 - f, 2))
                );
                m <= s &&
                  c.push({
                    dataPoint: d,
              ...
              case "doughnut":
                ...
                m < n.radius &&
                  ...
                  0 === s && 1 < n.endAngle && (s = 360),
                  q >= s && 0 !== d.y && ((s += 360), m < q && (m += 360)),
                  m > q &&
                    m < s &&
                    (c.push({
                      dataPoint: d,
              ...
              case "pyramid":
                ...
                f > m.y1 &&
                  ...
                  (m.y6
                    ? f > m.y6
                      ? ((g =
                          m.x6 + ((m.x5 - m.x6) / (m.y5 - m.y6)) * (f - m.y6)),
                        (m =
                          m.x3 + ((m.x4 - m.x3) / (m.y4 - m.y3)) * (f - m.y3)))
                      : ((g =
                          m.x1 + ((m.x6 - m.x1) / (m.y6 - m.y1)) * (f - m.y1)),
                        (m =
                          m.x2 + ((m.x3 - m.x2) / (m.y3 - m.y2)) * (f - m.y2)))
                    : ((g =
                        m.x1 + ((m.x4 - m.x1) / (m.y4 - m.y1)) * (f - m.y1)),
                      (m =
                        m.x2 + ((m.x3 - m.x2) / (m.y3 - m.y2)) * (f - m.y2))),
                  a > g &&
                    a < m &&
              ...
              case "boxAndWhisker":
                if (
                  (a >= n.x1 - n.borderThickness / 2 &&
                    ...
                    f >= n.y4 - n.borderThickness / 2 &&
                    f <= n.y1 + n.borderThickness / 2) ||
              ...
              case "candlestick":
                if (
                  (a >= n.x1 - n.borderThickness / 2 &&
                    a <= n.x2 + n.borderThickness / 2 &&
                    f >= n.y2 - n.borderThickness / 2 &&
                    f <= n.y3 + n.borderThickness / 2) ||
                  (Math.abs(n.x2 - a + n.x1 - a) < n.borderThickness &&
                    f >= n.y1 &&
                    f <= n.y4)
                )
              ...
              a ||
                ((a = this.labelFormatter
                  ...
                  : "axisX" === this.type && this.labels[m]
                    ? this.labels[m]
                    : V(m, this.valueFormatString, this.chart._cultureInfo)),
                (a = new ka(this.ctx, {
                  x: 0,
                  y: 0,
                  maxWidth: g,
      ...
      if (this.labelAutoFit || this.options.labelAutoFit)
        if (
          ...
          if (
                          ...
                          for (
                            ...
                            (a = this._labels[c].textBlock),
                              ...
                              c < this._labels.length - 1 &&
                                ((d = c + 1),
                                (f = this._labels[d].textBlock),
                                (f.maxWidth = this.sessionVariables.labelMaxWidth = Math.min(
                                  Math.max(g, n),
                                  m
                                )),
                                (f = f.measureText()),
            ...
            for (b = 0; b < this._labels.length; b++)
              (a = this._labels[b].textBlock),
                (a.maxWidth = this.labelMaxWidth = y(this.options.labelMaxWidth)
                  ? this.sessionVariables.labelMaxWidth
                  : this.options.labelMaxWidth),
                (a.fontSize = this.labelFontSize = y(this.options.labelFontSize)
                  ? this.sessionVariables.labelFontSize
                  : this.options.labelFontSize),
                (a.angle = this.labelAngle = y(this.options.labelAngle)
                  ? this.sessionVariables.labelAngle
                  : this.labelAngle),
                (a.wrap = this.labelWrap = y(this.options.labelWrap)
        ...
        for (f = 0; f < this._stripLineLabels.length; f++)
          "outside" === this._stripLineLabels[f].stripLine.labelPlacement &&
            (this._stripLineLabels[f].stripLine.value >= this.viewportMinimum &&
              this._stripLineLabels[f].stripLine.value <=
    ...
    C.setLayoutAndRender = function(a, f, b, c, e, g) {
      ...
      for (d = 0; d < n.length; d++)
        if (n[d] && n[d].scaleBreaks && n[d].scaleBreaks._appliedBreaks.length)
          for (
            var q = n[d].scaleBreaks._appliedBreaks, s = 0;
            s < q.length && !(q[s].startValue > n[d].viewportMaximum);
            s++
          )
            q[s].endValue < n[d].viewportMinimum ||
              (y(n[d].scaleBreaks.firstBreakIndex) &&
                (n[d].scaleBreaks.firstBreakIndex = s),
              q[s].startValue >= n[d].viewPortMinimum &&
                (n[d].scaleBreaks.lastBreakIndex = s));
      for (
        var x = (s = 0),
          u = 0,
          z = 0,
        ...
        n[d] &&
          n[d].title &&
          (n[d]._titleTextBlock = new ka(n[d].ctx, {
            text: n[d].title,
            horizontalAlign: "center",
        ...
        if (n[d].title)
          switch (n[d]._position) {
            ...
            case "right":
              ...
              break;
            default:
              (n[d]._titleTextBlock.maxWidth = n[d].titleMaxWidth || g.width),
                (n[d]._titleTextBlock.maxHeight = n[d].titleWrap
                  ? 0.8 * g.height
                  : 1.5 * n[d].titleFontSize),
                (n[d]._titleTextBlock.angle = 0);
          }
      if ("normal" === e) {
        for (
          var z = [], C = [], F = [], B = [], P = [], R = [], S = [], T = [];
          ...
          if (b && 0 < b.length)
            ...
            F.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateWidth() : 0));
          S.push(F);
          if (c && 0 < c.length)
          ...
          t = Math.round(
            g.x2 - ba - $ > m.width - 10 ? m.width - 10 : g.x2 - ba - $
          );
          if (a && 0 < a.length)
            for (z = [], d = Z = 0; d < a.length; d++)
              a[d] && (a[d].lineCoordinates = {}),
                (a[d].lineCoordinates.width = Math.abs(t - h)),
                a[d].title &&
          ...
          P.push(z);
          if (f && 0 < f.length)
            for (C = [], d = V = 0; d < f.length; d++)
              f[d] && (f[d].lineCoordinates = {}),
                (f[d].lineCoordinates.width = Math.abs(t - h)),
                f[d].title &&
          ...
          if (a && 0 < a.length)
            for (d = 0; d < a.length; d++)
              a[d] &&
                ...
                a[d] &&
                  (a[d].labelAutoFit && !y(A) && !y(I)) &&
                  ((l = 0),
                  0 < a[d].labelAngle
                    ? I + u > t &&
                      (l += 0 < a[d].labelAngle ? I + u - t - ba : 0)
                    : 0 > a[d].labelAngle
                      ? A - x < h &&
                        A - x < a[d].viewportMinimum &&
                        (J =
                          h -
                          (M +
                            a[d].tickLength +
                  ...
                  0 < l
                    ...
                    : a[d].viewportMaximum === a[d].maximum &&
                      ...
                      : a[d].viewportMaximum === a[d].maximum &&
                        ...
                        (0 < J && (h += J), 0 < l && (t -= l))),
                m.panEnabled
                  ? (Z = m.sessionVariables.axisX.height)
                  : (m.sessionVariables.axisX.height = Z),
                (l = Math.round(g.y2 - Z - e + E)),
                (k = Math.round(g.y2)),
                (a[d].lineCoordinates.x2 = t),
                (a[d].lineCoordinates.width = t - h),
          ...
          if (f && 0 < f.length)
            for (d = 0; d < f.length; d++)
              (f[d].lineCoordinates.x1 = Math.round(g.x1 + N + M)),
                ...
                f[d]._labels &&
                  ...
                  (u =
                    ...
                    (l.textBlock.height - l.textBlock.fontSize / 2) *
                      Math.sin((Math.PI / 180) * Math.abs(l.textBlock.angle)))),
                m.panEnabled
                  ? (V = m.sessionVariables.axisX2.height)
                  : (m.sessionVariables.axisX2.height = V),
                (l = Math.round(g.y1)),
                (k = Math.round(g.y2 + f[d].margin)),
                (f[d].lineCoordinates.y1 = l + V + W - U),
          ...
          for (d = 0; d < n.length; d++)
            "axisY" === n[d].type &&
              (n[d].calculateValueToPixelConversionParameters(),
              n[d].calculateBreaksSizeInValues());
          if (0 < s) {
            if (a && 0 < a.length)
              for (d = 0; d < a.length; d++)
                q = P[s - 1][d] === P[s][d] ? !0 : !1;
        ...
        for (S = []; 4 > s; ) {
          ...
          if (b && 0 < b.length)
            for (d = 0; d < b.length; d++)
              (b[d].lineCoordinates = {}),
                (h = Math.round(g.x1 + Z + e)),
                (t = Math.round(
                  g.x2 - V - W > m.width - 10 ? m.width - 10 : g.x2 - V - W
                )),
                b[d].labelAutoFit &&
                  !y(z) &&
                  (0 < !a.length &&
                ...
                (b[d].lineCoordinates.x2 = t),
                (b[d].lineCoordinates.width = Math.abs(t - h)),
                b[d].title &&
                  (b[d]._titleTextBlock.maxWidth =
                    0 < b[d].titleMaxWidth &&
          ...
          if (c && 0 < c.length)
            for (d = 0; d < c.length; d++)
              (c[d].lineCoordinates = {}),
                ...
                (c[d].lineCoordinates.x2 = t),
                (c[d].lineCoordinates.width = Math.abs(t - h)),
                c[d].title &&
                  (c[d]._titleTextBlock.maxWidth =
                    0 < c[d].titleMaxWidth &&
          ...
          if (c && 0 < c.length)
            ...
            J.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateHeight() : 0));
          P.push(J);
          if (b && 0 < b.length)
            for (d = 0; d < b.length; d++)
          ...
          if (b && 0 < b.length)
            for (d = b.length - 1; 0 <= d; d--)
              (l = Math.round(g.y2)),
                ...
                (b[d].lineCoordinates.y1 = l - (A[d] + b[d].margin + E)),
                (b[d].lineCoordinates.y2 = l - (A[d] + b[d].margin + E)),
                (b[d].bounds = {
                  x1: h,
          ...
          if (c && 0 < c.length)
            for (d = c.length - 1; 0 <= d; d--)
              c[d] &&
                ((l = Math.round(g.y1)),
                (k = Math.round(g.y1 + (J[d] + c[d].margin + U))),
                ...
                b && 0 < b.length
                  ? Math.round(
                      b[0]
                        ...
                        : g.y2 - X > m.height - Math.max(M, 10)
                          ? m.height - Math.max(M, 10)
                          : g.y2 - X
                    )
                  : g.y2 > m.height - Math.max(M, 10)
                    ? m.height - Math.max(M, 10)
                    : g.y2;
              if (b && 0 < b.length)
                    ...
                    ((t =
                      0 > b[M].labelAngle
                        ...
                        : 0 === b[M].labelAngle
                          ...
                          : t),
                    (h =
                      0 > b[M].labelAngle || 0 === b[M].labelAngle
                        ? t - Z
                        : h));
              if (c && 0 < c.length)
                for (M = 0; M < c.length; M++)
                  c[M] &&
                    c[M].labelAutoFit &&
                    ((t = c[M].lineCoordinates.x1), (h = t - Z));
              a[d].lineCoordinates = {
                x1: t - T,
                y1: l,
                x2: t - T,
            ...
            for (d = 0; d < f.length; d++) {
              ...
              if (c && 0 < c.length)
                for (M = 0; M < c.length; M++)
                  c[M] &&
                    c[M].labelAutoFit &&
                    ((t = c[M].lineCoordinates.x2), (h = t - V));
              f[d].lineCoordinates = {
                x1: t + Y,
                y1: l,
                x2: t + Y,
        ...
        for (k = 0; k < this._labels.length; k++)
          (p = this._labels[k]),
            p.position < this.viewportMinimum ||
              ...
              ((n = this.getPixelCoordinatesOnAxis(p.position)),
              this.tickThickness &&
                "inside" != this.labelPlacement &&
                ...
                this.ctx.stroke()),
              0 === p.textBlock.angle
                ? ((n.x -= p.textBlock.width / 2),
                  (n.y =
                    "inside" === this.labelPlacement
                      ? n.y - (this.tickLength + p.textBlock.fontSize / 2)
                      : n.y + this.tickLength + p.textBlock.fontSize / 2))
                : ((n.x =
                    "inside" === this.labelPlacement
                      ? 0 > this.labelAngle
            ...
            p.position < this.viewportMinimum ||
              ...
              0 === this.labelAngle
                ? ((p.textBlock.y = n.y),
                  (p.textBlock.x =
                    "inside" === this.labelPlacement
                      ? n.x - p.textBlock.width - this.tickLength - 5
                      : n.x + this.tickLength + 5))
                : ((p.textBlock.y =
                    "inside" === this.labelPlacement
                      ? n.y -
      ...
      if (this.scaleBreaks && 0 < this.scaleBreaks._appliedBreaks.length) {
        ...
        for (var f = 0; f < a.length; f++)
          a[f].endValue < this.viewportMinimum ||
            (a[f].startValue > this.viewportMaximum || isNaN(this.range)) ||
                              ...
                              : c / 300 <= a
                                ...
                                : c / 400 <= a
                                  ...
                                  : c / 500 <= a
                                    ? ((this.interval = 500),
                                      (this.intervalType = "millisecond"))
                                    : c / (1 * U.secondDuration) <= a
                                      ? ((this.interval = 1),
                                        (this.intervalType = "second"))
                                      : c / (2 * U.secondDuration) <= a
                                        ? ((this.interval = 2),
                                          (this.intervalType = "second"))
                                        : c / (5 * U.secondDuration) <= a
                                          ? ((this.interval = 5),
                                            (this.intervalType = "second"))
                                          : c / (10 * U.secondDuration) <= a
                                            ? ((this.interval = 10),
                                              (this.intervalType = "second"))
                                            : c / (15 * U.secondDuration) <= a
                                              ? ((this.interval = 15),
                                                (this.intervalType = "second"))
                                              : c / (20 * U.secondDuration) <= a
                                                ? ((this.interval = 20),
                                                  (this.intervalType =
                                                    "second"))
                                                : c / (30 * U.secondDuration) <=
                                                  a
                                                  ? ((this.interval = 30),
                                                    (this.intervalType =
                                                      "second"))
    ...
    C.prototype.calculateLogarithmicAxisParameters = function() {
      ...
      h = Math.pow(
        this.logarithmBase,
        C.getNiceNumber(Math.abs(Math.log(h) / f), !1)
      );
      this.options && 0 < this.options.interval
        ? (this.interval = this.options.interval)
        : ((this.interval = C.getNiceExponent(Math.log(h) / f / (a - 1), !0)),
          (b = C.getNiceNumber(linearRange / (a - 1), !0)));
      if (null === this.viewportMinimum || isNaN(this.viewportMinimum))
        this.viewportMinimum =
          "axisX" === this.type
            ? c / Math.sqrt(g)
          ...
          if (
            ...
            "top" === this.scaleBreaks.parent._position
              ...
              : ((e = this.chart.plotArea.y2),
                ...
                (a *= -1)),
            (this.bounds = { x1: c - p / 2, y1: e, x2: h + p / 2, y2: l }),
            this.ctx.moveTo(c, e),
            "straight" === this.type ||
          ...
          if (
            ...
            "left" === this.scaleBreaks.parent._position
              ...
              : ((c = this.chart.plotArea.x2),
                ...
                (a *= -1)),
            (this.bounds = { x1: c, y1: e - p / 2, x2: h, y2: l + p / 2 }),
            this.ctx.moveTo(c, e),
            "straight" === this.type ||
      ...
      if (this.snapToDataPoint) {
        ...
        if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
          ...
          for (var q = 0; q < this.parent.dataSeries.length; q++)
            (d = this.parent.dataSeries[q].getDataPointAtX(n, !0)) &&
              0 <= d.index &&
              ((d.dataSeries = this.parent.dataSeries[q]),
          ...
          if (
            ...
            for (
              var d = Math.abs(
                  a - this.parent.convertValueToPixel(h[q].dataPoint.y[0])
                ),
                s = 0,
                n = 0;
              n < h.length;
              ...
              if (h[n].dataPoint.y && h[n].dataPoint.y.length)
                for (m = 0; m < h[n].dataPoint.y.length; m++)
                  (s = Math.abs(
                    a - this.parent.convertValueToPixel(h[n].dataPoint.y[m])
                  )),
                    s < d && ((d = s), (q = n));
              else
                (s = Math.abs(
                  a - this.parent.convertValueToPixel(h[n].dataPoint.y)
                )),
                  s < d && ((d = s), (q = n));
            ...
            for (
              ...
              if (h[n].dataPoint.y && h[n].dataPoint.y.length)
                ...
                (v += h[n].dataPoint.y),
                  (u = h[n].dataPoint.x.getTime
                    ? h[n].dataPoint.x.getTime()
                    : h[n].dataPoint.x),
                  (u = 100 * (v / h[n].dataSeries.plotUnit.dataPointYSums[u])),
          ...
          if (
            ...
            if (
              ...
              d = Math.abs(
                a - this.parent.convertValueToPixel(m.dataPoint.y[0])
              );
              for (n = s = 0; n < m.dataPoint.y.length; n++)
                (s = Math.abs(
                  a - this.parent.convertValueToPixel(m.dataPoint.y[n])
                )),
                  s < d && ((d = s), (b = n));
              h =
                1 === r.lineWidth % 2
                  ? (this.parent.convertValueToPixel(m.dataPoint.y[b]) << 0) +
                    0.5
                  : this.parent.convertValueToPixel(m.dataPoint.y[b]) << 0;
              ...
              l.text = this.labelFormatter
                ...
                : y(this.options.label)
                  ? V(u, this.valueFormatString, this.chart._cultureInfo)
                  : this.label;
            } else
              (h =
                1 === r.lineWidth % 2
                  ? (this.parent.convertValueToPixel(m.dataPoint.y) << 0) + 0.5
                  : this.parent.convertValueToPixel(m.dataPoint.y) << 0),
                (l.text = this.labelFormatter
                  ? this.labelFormatter({
                      chart: this.chart,
                      axis: this.parent.options,
            ...
            e = g = h =
              1 === r.lineWidth % 2
                ? (this.parent.convertValueToPixel(m.dataPoint.x) << 0) + 0.5
                : this.parent.convertValueToPixel(m.dataPoint.x) << 0;
          ...
          if (u) {
            if ("axisX" === this.parent.type)
              for (
                n = this.parent.convertPixelToValue({ x: a }), d = null, q = 0;
                q < this.parent.dataSeries.length;
                q++
              )
                (d = this.parent.dataSeries[q].getDataPointAtX(n, !0)) &&
          ...
          if (
            ...
            for (
              ...
              if (h[n].dataPoint.y && h[n].dataPoint.y.length)
                for (m = 0; m < h[n].dataPoint.y.length; m++)
                  (s = Math.abs(
                    f - this.parent.convertValueToPixel(h[n].dataPoint.y[m])
                  )),
                    s < d && ((d = s), (q = n));
              else
                (s = Math.abs(
                  f - this.parent.convertValueToPixel(h[n].dataPoint.y)
                )),
                  s < d && ((d = s), (q = n));
          else if (
          ...
          if (
            ...
            for (n = s = 0; n < m.dataPoint.y.length; n++)
              (s = Math.abs(
                f - this.parent.convertValueToPixel(m.dataPoint.y[n])
              )),
                s < d && ((d = s), (b = n));
            h =
              1 === r.lineWidth % 2
                ? (this.parent.convertValueToPixel(m.dataPoint.y[b]) << 0) + 0.5
                : this.parent.convertValueToPixel(m.dataPoint.y[b]) << 0;
            l.text = this.labelFormatter
              ? this.labelFormatter({
                  chart: this.chart,
              ...
              ? ((h =
                  1 === r.lineWidth % 2
                    ? (this.parent.convertValueToPixel(
                        m.dataSeries.dataPointEOs[m.index].cumulativeSum
                      ) <<
                        0) +
                      0.5
                    : this.parent.convertValueToPixel(
      ...
      if (!this.chart.disableToolTip) {
        ...
        if (
          ...
          if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
            ...
            if (this.chart.axisX)
              for (var m = 0; m < this.chart.axisX.length; m++) {
                for (
                  var h = this.chart.axisX[m].convertPixelToValue({ y: f }),
                    k = null,
                    c = 0;
                  c < this.chart.axisX[m].dataSeries.length;
                  c++
                )
                  (k = this.chart.axisX[m].dataSeries[c].getDataPointAtX(
                    h,
                    b
                  )) &&
                    0 <= k.index &&
                    ((k.dataSeries = this.chart.axisX[m].dataSeries[c]),
                    null !== k.dataPoint.y && l.push(k));
                k = null;
              }
            if (this.chart.axisX2)
              for (m = 0; m < this.chart.axisX2.length; m++) {
                h = this.chart.axisX2[m].convertPixelToValue({ y: f });
                k = null;
                for (c = 0; c < this.chart.axisX2[m].dataSeries.length; c++)
                  (k = this.chart.axisX2[m].dataSeries[c].getDataPointAtX(
                    h,
                    b
                  )) &&
                    0 <= k.index &&
                    ((k.dataSeries = this.chart.axisX2[m].dataSeries[c]),
                    null !== k.dataPoint.y && l.push(k));
                k = null;
              }
          } else {
            ...
            if (this.chart.axisX)
              for (m = 0; m < this.chart.axisX.length; m++)
                for (
                  h = this.chart.axisX[m].convertPixelToValue({ x: a }),
                    k = null,
                    c = 0;
                  c < this.chart.axisX[m].dataSeries.length;
                  c++
            ...
            if (this.chart.axisX2)
              for (m = 0; m < this.chart.axisX2.length; m++)
                for (
                  h = this.chart.axisX2[m].convertPixelToValue({ x: a }),
                    k = null,
                    c = 0;
                  c < this.chart.axisX2[m].dataSeries.length;
                  c++
                )
                  (k = this.chart.axisX2[m].dataSeries[c].getDataPointAtX(
                    h,
          ...
          if ((k = this.chart.getDataPointAtXY(a, f, b)))
            ...
            if (
              ((k = Wa(a, f, this.chart._eventManager.ghostCtx)),
              0 < k &&
                  ...
                  "column" === e.type || "bar" === e.type
                    ...
                    : "bubble" === e.type
                      ? ((b =
                        ...
                        k.dataPoint.y >=
                          k.dataSeries.axisY.viewportMinimum - b &&
                          k.dataPoint.y <=
                ...
                : "column" === c.type ||
                  ...
                  : "pie" === c.type || "doughnut" === c.type
                    ...
                    : "funnel" === c.type || "pyramid" === c.type
                      ? qa(f, e.funnelSection, 0.3, "white")
                      : "candlestick" === c.type
                        ? ((f.globalAlpha = 1),
